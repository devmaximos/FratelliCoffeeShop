...
const testimonials = [
  {
    ...
    name: "Βασίλειος Κ.",
    rating: 5,
    text: "Πολύ αξιοπρεπής καφές Illy  (πήρα espresso  όπου καταλαβαίνεις άμεσα την ποιότητα του καφέ) και φιλική εξυπηρέτηση.",
    date: "Πριν 2 μήνες",
  },
  {
    id: 2,
    name: "Alex Mar",
    rating: 5,
    text: "Ωραίος καφές, γρήγορη εξυπηρέτηση, ευγενικό προσωπικό, χώρος στάθμευσης απ έξω για ολιγόλεπτη στάση. Διαθέτει και εξωτερικά καθίσματα.",
    date: "Πριν 1 μήνα",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    name: "Νίκος Σ.",
    rating: 5,
    text: "Πολύ ωραίο. Για ξεκούραση και έναν καλό καφέ, περάστε στο δρόμο σας προς την ελληνική παραλία ή στο δρόμο της επιστροφής. Ευγενικό προσωπικό. Πολύ ωραίο μέρος. Περάστε για ξεκούραση και καλό καφέ στο δρόμο σας προς την ελληνική παραλία ή στο δρόμο της επιστροφής. Ευγενικό προσωπικό.",
