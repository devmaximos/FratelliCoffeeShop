...
const locations = [
  {
    ...
    hours: [
      { day: "Δευτέρα - Παρασκευή", time: "06:30 - 22:00" },
      { day: "Σάββατο", time: "07:00 - 22:00" },
      { day: "Κυριακή", time: "08:00 - 22:00" },
    ],
    phone: "+30 2321 119904",
    mapEmbed: "https://maps.google.com/maps?width=600&height=400&hl=el&q=" + encodeURIComponent("Θουκυδίδου 41, Σέρρες 621 24") + "&t=&z=17&ie=UTF8&iwloc=B&output=embed",
    mapLink: "https://www.google.com/maps/search/?api=1&query=Θουκυδίδου+41+Σέρρες",
  },
  {
    id: "bekiari",
    name: "Μπεκιάρη",
    address: "Μπεκιάρη 27, Σέρρες 62125",
    hours: [
      { day: "Δευτέρα - Παρασκευή", time: "06:30 - 22:00" },
      { day: "Σάββατο", time: "06:30 - 22:00" },
      { day: "Κυριακή", time: "05:30 - 22:00" },
    ],
    phone: "+30 2321 119904",
    mapEmbed: "https://maps.google.com/maps?width=600&height=400&hl=el&q=" + encodeURIComponent("Μπεκιάρη 27, Σέρρες 621 25") + "&t=&z=17&ie=UTF8&iwloc=B&output=embed",
